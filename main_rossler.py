...
# ------------------------------------------------
discarded_time                 = 70      # [s] all time between start and discarded_time (excluded) is discarded
min_duration_first_quasiperiod = 0      # [s]
listening_time                 = 60    # [s] waits this time before estimating first loop must contain 2 quasiperiods
...
file_path_estimand  = r"data\rossler\rossler_1.csv"
col_names_pos_estimand = ['x', 'y', 'z']
time_step           = 0.01  # [s]
...
# Load data
# ------------------------------------------------
df_estimand = pd.read_csv(file_path_estimand,  low_memory=False)
